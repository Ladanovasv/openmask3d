...
def test_pipeline_full_scannet200(mask_features_dir,
                                    pred_root_dir,
                                    sentence_structure,
                                    feature_file_template='_openmask3d_featurs.npy',
...
if __name__ == '__main__':
    ...
    test_pipeline_full_scannet200(opt.mask_features_dir, opt.mask_pred_dir, opt.sentence_structure, opt.feature_file_template, dataset_type='scannet200', clip_model_type='ViT-L/14@336px', keep_first=None, masks_template=opt.masks_template)
